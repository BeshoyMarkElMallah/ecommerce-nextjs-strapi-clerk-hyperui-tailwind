  ...
  <div className="max-w-screen-xl px-4 py-32 mx-auto lg:flex lg:h-screen">
    <div className="max-w-xl mx-auto text-center">
      ...
      <div className="flex flex-wrap justify-center gap-4 mt-8">
        ...
        <a
          className="block w-full px-12 py-3 text-sm font-medium text-teal-500 rounded shadow hover:text-primary focus:outline-none focus:ring active:text-red-500 sm:w-auto"
          href="#"
        >
          Learn More
        </a>
